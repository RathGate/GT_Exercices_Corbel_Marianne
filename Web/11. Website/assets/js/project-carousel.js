// CAROUSEL
const SKILLS_NAME = ["SOFTWARE DEVELOPMENT", "WEB DEVELOPMENT | FRONT-END", "WEB-DEVELOPMENT | BACK-END", "GAME PROGRAMING LMAO"]
...
function switchSkillTitle() {
    skillTitle.innerHTML = SKILLS_NAME[currSlideIndex]
}
